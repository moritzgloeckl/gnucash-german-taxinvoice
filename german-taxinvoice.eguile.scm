...
<tr valign="top" style="vertical-align: top">
  ...
  <td align="right"><table border="0">
      ...
      <?scm (if coyphone (begin ?>
        <tr>
          <td align="left"><?scm:d (G_ "Phone") ?>:&nbsp;</td>
          <td align="right"><?scm:d coyphone ?></td>
        </tr>
      <?scm )) ?>
      <?scm (if coyfax (begin ?>
        <tr>
          <td align="left"><?scm:d (G_ "Fax") ?>:&nbsp;</td>
          <td align="right"><?scm:d coyfax ?></td>
        </tr>
      <?scm )) ?>
      <?scm (if coyemail (begin ?>
        <tr>
          <td align="left"><?scm:d (G_ "Email") ?>:&nbsp;</td>
          <td align="right"><?scm:d coyemail ?></td>
        </tr>
      <?scm )) ?>
      <?scm (if coyurl (begin ?>
        <tr>
          <td align="left"><?scm:d (G_ "Website") ?>:&nbsp;</td>
...
<tr valign="top">
  ...
  <td align="right">
    <table border="0">
      ...
      <tr>
        <td align="right" class="invnum"><?scm:d (nbsp opt-invoice-number-text) ?></td>
        <td align="right" class="invnum"><?scm:d invoiceid ?></td>
      </tr>
      <?scm )) ?>
